// У каждого объекта HTML элемента есть метод "addEventListener". Он принимает 2 аргумента:
	// 1. Имя события 
	// 2. Имя CallBack функции или саму CallBack функцию, которая исполняется когда обработчик события регистрирует событие

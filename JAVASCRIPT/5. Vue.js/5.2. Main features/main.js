...
/*********************************Components*******************************/
//Компоненты можно создавать как глобально так и локально
// Глобально - vue.component
//    локально var cmp = {}; Указхать внутри vue объекта каккой component будет использоваться

// var data = {status: 'Criticsl'};
var cmp = {
    data: function(){
        return {
            status: 'Criticsl'

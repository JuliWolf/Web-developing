...
@section('styles')
    <link rel="stylesheet" href="https://maxcdn//maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="{{ URL::asset('src/css/category.css') }}">
@endsection
